...
<template>
  <Disclosure v-slot="{ open }" as="nav" class="shadow bg-primary-50 dark:bg-primary-800">
      ...
      <div class="flex justify-between h-16">
        ...
        <div class="-mr-2 flex items-center sm:hidden gap-4">
          ...
          >
            ...
            <Icon v-if="!open" name="clarity:menu-line" aria-hidden="true" />
