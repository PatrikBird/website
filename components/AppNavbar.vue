      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:space-x-8 text-primary-700 dark:text-primary-200">
              <!-- Navigation -->
              <NuxtLink
          ...
          <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-3 transition text-primary-500">
            <a
          ...
          <div class="-mr-2 flex items-center sm:hidden gap-4">
            ...
            >
              ...
              <Icon v-if="!mobileIsOpen" name="clarity:menu-line" aria-hidden="true" />
