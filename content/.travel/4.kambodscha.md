...
imageUrl: '/travel/cambodia/angkorWatCover_fknur9.avif'
date: '2023-03-10'
_locale: 'de'
---
...
Außerdem habe ich eine _Swipe_-Funktion à la Instagram 😎 eingebaut,
...
Durch Zufall fanden wir im Grenzort _Hà Tiên_ in Vietnam einen Bus,
der uns direkt nach _Kampot_ in Kambodscha brachte.
...
![Der berühmte Pfeffer Shop in Kampot.](/travel/cambodia/IMG_8007_rgavg6.avif){loading=eager}

Wir hörten von einer **kostenlosen** Fahrradtour durch Kampot und...
sind natürlich mitgefahren. 🤷
Ein _Expat_ (Ausländer, davon gibt es hier viele in Form
...
---
pics: [
  { src: '/travel/cambodia/templeCoat_hpnbob.avif', alt: 'Ein Tempel irgendwo bei Kampot.'},
  { src: '/travel/cambodia/tempelKampot_xlcsyq.avif', alt: 'Ein anderer Tempel irgendwo bei Kampot.'},
  { src: '/travel/cambodia/school_d2mnhf.avif', alt: 'Auf der Suche nach einer Toilette in einer Schule. Es waren gerade Ferien.'},
  { src: '/travel/cambodia/buddhaSkulls_xucv4h.avif', alt: 'Buddha Statue wirft einen Schatten auf die Schädel, die aus der Zeit der Roten Khmer stammen...'},
  { src: '/travel/cambodia/noHumanTrafficking_wups4q.avif', alt: '"Menschenhandel verboten" - das Schild lag auf unserem Zimmer.'},
]
---
::
...
begrüßten uns meist mit einem _Hello!_ und einem breiten Grinsen. 😊

::Swiper
---
pics: [
  { src: '/travel/cambodia/cyclingLandscape_wvb1ur.avif', alt: 'Radeln, irgendwo bei Kampot.'},
  { src: '/travel/cambodia/kampotCountrysideWateringSystem_s0hkr8.avif', alt: 'Salzfelder bei Kampot.'},
]
---
::
...
## Sihanoukville
Wir hatten von der miserablen Straße von _Kampot_ nach _Sihanoukville_ gehört
...
---
pics: [
  { src: '/travel/cambodia/kampotTrain_g7eyzc.avif', alt: 'ROYAL 👑 was sonst.'},
  { src: '/travel/cambodia/kampotTrainTicketSeller_jljsxq.avif', alt: '"Ticket Seller" mit Kugelschreiber auf die Wand geschmiert. Der Zug kommt einmal am Tag.'},
  { src: '/travel/cambodia/kampotTrainInside_lmtli1.avif', alt: 'So sieht es drinnen aus. Zwei lange Reihen "casting couches" in Blau.'},
  { src: '/travel/cambodia/kampotRails_jlxfi4.avif', alt: 'DIE Strecke in Kambodscha.'},
]
---
::
...
![Sihanoukville aus dem TukTuk. Die Baustellen ziehen sich durch die ganze Stadt.](/travel/cambodia/IMG_8066_daadah.avif)

Hoffentlich nimmt die Stadt wieder an Fahrt auf.
Die Menschen sind darauf angewiesen: Wir wurden ständig mit
_Bitte gebt uns einen Job_ 😔 angesprochen. (Privileg+1)

## Koh Rong
Nach nur einer Nacht fuhren wir mit einem Versorgungsboot nach _Koh Rong_.
...
---
pics: [
  { src: '/travel/cambodia/supplyBoatPigs_irdt1a.avif', alt: 'Am Versorgungsboot - links sind die Tiere zu sehen...'},
  { src: '/travel/cambodia/supplyBoatSitting_qjyjs4.avif', alt: 'Platz war knapp. Die schwarze Plane verdeckt das Eis, welches zur Kühlung auf der Insel verwendet wird.'},
]
---
::
Die Fahrt hat Spaß gemacht, war günstig und hat uns nah an unsere Unterkunft
_Lonely Beach_ gebracht.
...
---
pics: [
  { src: '/travel/cambodia/kohRongBeach_giwmtm.avif', alt: 'Wasser und Strand waren ✨ - zudem wenig andere Menschen.'},
  { src: '/travel/cambodia/kohRongSunsetLandscape_l7zqcf.avif', alt: 'Sonnenuntergang ah recht schee.'},
  { src: '/travel/cambodia/kohRongSunsetLandscape2_umafwo.avif', alt: '...'},
]
---
::
...
Entwicklungsstand aus) Kambodschas in die Hauptstadt _Phnom Penh_,
...
gibt es dort ein Museum und _killing fields_ usw., wir waren jedoch gesättigt. 😬
Nach ein paar Tagen sind wir sind mit dem Bus weiter nach _Siem Reap_ gefahren,
um die Tempel von Angkor zu besichtigen.

## Angkor Wat
![Sonnenaufgang bei Angkor Wat.](/travel/cambodia/angkorWatSunrise_x9sihu.avif){width=801 height=602}

Die Stadt _Siem Reap_ liegt in der Nähe der Tempelanlagen von Angkor und
wird daher auch _Tor zu Angkor Wat_ genannt. Die Stadt ist daher sehr touristisch,
...
da es als _Männerjob_ (weil besser bezahlt) gilt. 🤡
...
---
pics: [
  { src: '/travel/cambodia/angkorWatFigTree_h1ytsd.avif', alt: '"Ta Prohm" - Auch als "Tomb Raider Tempel" bekannt. Angelina Jolie stand neben dem Baum. *scream*'},
  { src: '/travel/cambodia/angkorWatAnotherTree_yk895q.avif', alt: 'Das sieht man hier häufig. Absolut...'},
  { src: '/travel/cambodia/angkorWatMoreTree_bnxrfm.avif', alt: '...crazy'},
  { src: '/travel/cambodia/meAngkorWatInstructions_aenlca.avif', alt: 'Me - supervising.'},
]
---
::
...
---
pics: [
  { src: '/travel/cambodia/battambangSunset_pnakm2.avif', alt: 'Sonnenuntergang. Die Touris warten auf die Fledermäuse. '},
  { src: '/travel/cambodia/batsFlying_ydmjcp.avif', alt: 'Es ging los sobald die Sonne verschwunden war.'},
  { src: '/travel/cambodia/batsWaveSunset_kt8hax.avif', alt: 'Ein endloser schwarm Fledermäuse.'},
]
---
::
...
Danach sind wir nach _Thailand_ zurückgekehrt und haben uns _Pattaya_
...
_Bangkok_ gefahren. Dort haben wir eine Wohnung gemietet, in der wir uns selbst
...
spontan) nach _Südkorea_ geflogen.
...
![Seoul](/travel/cambodia/IMG_2646_kaijpq.avif){width=801 height=602}
...
Ziel konzentrieren. Am 14.03. geht's weiter nach _Taiwan_. 🇹🇼

![Ich - am Blog schreiben.](/travel/cambodia/IMG_0122_d8loll.avif)
